namespace LiveTubeReport.View{
	partial class ChannelSelectForm {
		...
		private void InitializeComponent() {
			...
			this.AddedDataColumn = new System.Data.DataColumn();
			...
			this.AddedDGVColumn = new System.Windows.Forms.DataGridViewCheckBoxColumn();
			...
			// AddedDataColumn
			// 
			this.AddedDataColumn.ColumnMapping = System.Data.MappingType.Hidden;
			this.AddedDataColumn.ColumnName = "Added";
			this.AddedDataColumn.DataType = typeof(bool);
			// 
			// dataGridView
			// 
			...
			this.SelectCount.Visible = false;
			// 
			...
			// 
			this.dataGridViewImageColumn6.DataPropertyName = "Thumbnail";
			...
			// 
			this.dataGridViewImageColumn7.DataPropertyName = "Thumbnail";
			...
			this.dataGridViewImageColumn7.MinimumWidth = 25;
			...
			this.SelectedDGVColumn.MinimumWidth = 50;
			...
			this.SelectedDGVColumn.Width = 50;
			// 
			// IndexDGVColumn
			// 
			...
			// AddedDGVColumn
			// 
			this.AddedDGVColumn.DataPropertyName = "Added";
			this.AddedDGVColumn.HeaderText = "Added";
			this.AddedDGVColumn.Name = "AddedDGVColumn";
			this.AddedDGVColumn.Visible = false;
			// 
			// ChannelSelectForm
			// 
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ChannelSelectForm_FormClosing);
		...
		private System.Data.DataColumn AddedDataColumn;
		...
		private System.Windows.Forms.DataGridViewCheckBoxColumn AddedDGVColumn;
	}
}